...
@Named
@ViewScoped
public class ProcessProgressAction extends BaseAction<ProcessProgress>{
    ...
    @Override
    public List<ProcessProgress> getList() {
        if(super.getList()==null || super.getList().isEmpty()){
            Map<String,Object> params = new HashMap<String,Object>();
            params.put("mrchntid",merchant.getId());
           super.setList(new ArrayList<ProcessProgress>());
           if(Helper.getCurrentUserIsAdmin()){
               super.getList().addAll(getCrud().getNamedList("ProcessProgress.findAll"));
           }else{
                super.getList().addAll(getCrud().getNamedList("ProcessProgress.findProcessProgressByMerchant",params));
           }
        }
